/*
 * Purpose: Honors Design and Analysis of Algorithms Assignment 1 Problem 2
...
public class Driver1 { //formerly NQueensP2
        ...
        for (int i = 0; i < n && loop == true; i++) // i = active index
        {
            ...
            for (int j = 0; j < n && valid == false; j++) {
                ...
                if (valid == false && j == n - 1) {
                    ...
                    solFound = true;
                    numSols++;
                    sb.append("Solution #" + numSols + " for " + n + " Queens:\n");
    ...
    private static void display() {
        if (solFound == true) {
            sb.append(numSols + " Solutions have been found.\n");
        } else {
